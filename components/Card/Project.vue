...
<template>
    <div class="flex flex-col w-full h-[80vh] bg-white  rounded-lg shadow dark:bg-gray-800 md:flex-row">
            <img class="rounded-t-lg w-[100%] max-w-none max-h-[40vh] md:max-h-none md:max-w-[45vw] object-cover" :src="image" alt="" />
