...
<template>
    <footer class="w-full bg-white shadow dark:bg-gray-900">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://Openapp.com/" class="hover:underline">Openapp™</a>. All Rights Reserved.</span>
        </div>
    </footer>
</template>
