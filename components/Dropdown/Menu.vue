...
<template>
    <div class="relative inline-block">
      <button class="flex items-center align-middle justify-center border-[#4848482a] text-[#48484863]   border-2 border-spacing-1 dark:text-[#ffffff9c] dark:border-[#ffffff6a] rounded-full" @click="toggleDropdown" :title="title" >
