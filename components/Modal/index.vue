<template>
    <form @submit.prevent="" class="flex items-center justify-center fixed inset-0 w-screen h-screen bg-[#e9e9e96e] z-50">
      <div class="flex flex-col items-center gap-3 absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] px-6 py-8 rounded-sm bg-[#f4f4f4] dark:bg-gray-800 shadow-md  text-center" :style="{ borderColor: color}">
