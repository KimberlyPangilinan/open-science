...
<template>
    <div class="w-[100%] px-8 py-4 ">
        <header class="flex justify-between">
            <h1 class="uppercase font-bold text-gray-800 dark:text-[#f4f4f4] text-sm px-8 xl:px-0">Collaborations</h1>
            <div>
                <ButtonPrimary @handleClick="">Collaborate<Icon icon="ion:add-outline"/></ButtonPrimary>
            </div>
        </header>
        <p class="text-gray-800 dark:text-[#f4f4f4] text-sm px-8 xl:px-0">Project that you are collaborating with.</p>
